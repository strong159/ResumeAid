...
openai.api_key = os.getenv("k-valZhRj1rZV2BvtNaK8NT3BlbkFJnvEdgFwRRk69BdLF4CLi")
...
interview_context = {
    ...
    "user_responses": []  # Initialize user_responses here
}
...
async def submit_response(user_response: str = Form(...)):
    if "user_responses" not in interview_context:
